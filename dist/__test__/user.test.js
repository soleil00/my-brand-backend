...
(0, globals_1.describe)("Test Get single user", () => {
    (0, globals_1.test)('Test user not found', () => __awaiter(void 0, void 0, void 0, function* () {
        globals_1.jest.spyOn(userMode_1.default, "findById").mockResolvedValueOnce(undefined);
        const users = yield (0, supertest_1.default)(server_1.default).get("/api/v1/users/soemrandomstirngforuser").set({ "Authorization": `Bearer ${token}` });
        (0, globals_1.expect)(users.status).toBe(404);
    }));
